...
CF2PY INTENT(HIDE) :: MAXCLY, MAXUMU, MAXPHI, MAXULV, MAXMOM
CF2PY INTENT(IN)   :: NLYR, DTAUC, SSALB, NMOM, PMOM, TEMPER
CF2PY INTENT(IN)   :: WVNMLO, WVNMHI, USRTAU, NTAU, UTAU, NSTR
CF2PY INTENT(IN)   :: USRANG, NUMU, UMU, NPHI, PHI, IBCND, FBEAM
CF2PY INTENT(IN)   :: UMU0, PHI0, FISOT, LAMBER, ALBEDO, BTEMP
CF2PY INTENT(IN)   :: TTEMP, TEMIS, PLANK, ONLYFL, ACCUR, PRNT, HEADER
